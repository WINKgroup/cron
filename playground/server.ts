...
new DemoCronRunner(5, webserver.ioApp!.of('/cron-runner'), {
    consoleLog: new ConsoleLog({ verbosity: LogLevel.DEBUG, prefix: 'DemoCronRunner' })
})
webserver.app.get('/', (req:any, res:any) => res.sendFile(path.join(__dirname, './controlPage.html')))
